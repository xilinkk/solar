(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        da.init();
        const openPopupBtnInverter1 = document.querySelector("#inverter-popup-button-1");
        const openPopupBtnInverter2 = document.querySelector("#inverter-popup-button-2");
        const openPopupBtnInverter3 = document.querySelector("#inverter-popup-button-3");
        const openPopupBtnInverter4 = document.querySelector("#inverter-popup-button-4");
        const openPopupBtnInverter5 = document.querySelector("#inverter-popup-button-5");
        const openPopupBtnInverter6 = document.querySelector("#inverter-popup-button-6");
        const iframeInverter1 = document.querySelector("#iframe-inverter-1");
        const iframeInverter2 = document.querySelector("#iframe-inverter-2");
        const iframeInverter3 = document.querySelector("#iframe-inverter-3");
        const iframeInverter4 = document.querySelector("#iframe-inverter-4");
        const iframeInverter5 = document.querySelector("#iframe-inverter-5");
        const iframeInverter6 = document.querySelector("#iframe-inverter-6");
        const openPopupBtnInverterMobile1 = document.querySelector("#inverter-popup-mobile-button-1");
        const openPopupBtnInverterMobile2 = document.querySelector("#inverter-popup-mobile-button-2");
        const openPopupBtnInverterMobile3 = document.querySelector("#inverter-popup-mobile-button-3");
        const openPopupBtnInverterMobile4 = document.querySelector("#inverter-popup-mobile-button-4");
        ...
        const openPopupBtnBattery3 = document.querySelector("#battery-popup-button-3");
        const openPopupBtnBattery4 = document.querySelector("#battery-popup-button-4");
        const openPopupBtnBattery5 = document.querySelector("#battery-popup-button-5");
        const openPopupBtnBattery6 = document.querySelector("#battery-popup-button-6");
        const iframeBattery1 = document.querySelector("#iframe-battery-1");
        const iframeBattery2 = document.querySelector("#iframe-battery-2");
        const iframeBattery3 = document.querySelector("#iframe-battery-3");
        const iframeBattery4 = document.querySelector("#iframe-battery-4");
        const iframeBattery5 = document.querySelector("#iframe-battery-5");
        const iframeBattery6 = document.querySelector("#iframe-battery-6");
        const openPopupBtnBatteryMobile1 = document.querySelector("#battery-popup-mobile-button-1");
        const openPopupBtnBatteryMobile2 = document.querySelector("#battery-popup-mobile-button-2");
        const openPopupBtnBatteryMobile3 = document.querySelector("#battery-popup-mobile-button-3");
        const openPopupBtnBatteryMobile4 = document.querySelector("#battery-popup-mobile-button-4");
        const openPopupBtnBatteryMobile5 = document.querySelector("#battery-popup-mobile-button-5");
        const openPopupBtnBatteryMobile6 = document.querySelector("#battery-popup-mobile-button-6");
        openPopupBtnBattery1.addEventListener("click", (() => {
            iframeBattery1.src = "https://drive.google.com/file/d/1Qc6gFI_zHtCGJT9qy9IhhqwwS5vBuaeo/preview";
        }));
        openPopupBtnBattery2.addEventListener("click", (() => {
            iframeBattery2.src = "https://drive.google.com/file/d/1Kf4Wv-2MUs4DQyAE-HvGKdGxsMcjgV5K/preview";
        }));
        openPopupBtnBattery3.addEventListener("click", (() => {
            iframeBattery3.src = "https://drive.google.com/file/d/1XCs70BE-JhToiN-66jCMjwfQqYgQ0eCV/preview";
        }));
        openPopupBtnBattery4.addEventListener("click", (() => {
            iframeBattery4.src = "https://drive.google.com/file/d/17lhxooMUl6FAULDG4HnTnIwnLF7rNVF5/preview";
        }));
        ...
        openPopupBtnBatteryMobile2.addEventListener("click", (() => {
            iframeBattery2.src = "https://drive.google.com/file/d/1Kf4Wv-2MUs4DQyAE-HvGKdGxsMcjgV5K/preview";
        }));
        openPopupBtnBatteryMobile3.addEventListener("click", (() => {
            iframeBattery3.src = "https://drive.google.com/file/d/1XCs70BE-JhToiN-66jCMjwfQqYgQ0eCV/preview";
        }));
        openPopupBtnBatteryMobile4.addEventListener("click", (() => {
            iframeBattery4.src = "https://drive.google.com/file/d/17lhxooMUl6FAULDG4HnTnIwnLF7rNVF5/preview";
        }));
        ...
        const openPopupBtnPanel3 = document.querySelector("#panel-popup-button-3");
        const openPopupBtnPanel4 = document.querySelector("#panel-popup-button-4");
        const openPopupBtnPanel5 = document.querySelector("#panel-popup-button-5");
        const openPopupBtnPanel6 = document.querySelector("#panel-popup-button-6");
        const iframePanel1 = document.querySelector("#iframe-panel-1");
        const iframePanel2 = document.querySelector("#iframe-panel-2");
        const iframePanel3 = document.querySelector("#iframe-panel-3");
        const iframePanel4 = document.querySelector("#iframe-panel-4");
        const iframePanel5 = document.querySelector("#iframe-panel-5");
        const iframePanel6 = document.querySelector("#iframe-panel-6");
        const openPopupBtnPanelMobile1 = document.querySelector("#panel-popup-mobile-button-1");
        const openPopupBtnPanelMobile2 = document.querySelector("#panel-popup-mobile-button-2");
        const openPopupBtnPanelMobile3 = document.querySelector("#panel-popup-mobile-button-3");
        const openPopupBtnPanelMobile4 = document.querySelector("#panel-popup-mobile-button-4");
        const openPopupBtnPanelMobile5 = document.querySelector("#panel-popup-mobile-button-5");
        const openPopupBtnPanelMobile6 = document.querySelector("#panel-popup-mobile-button-6");
        openPopupBtnPanel1.addEventListener("click", (() => {
            iframePanel1.src = "https://drive.google.com/file/d/1lvuyKWoOtU-Jb5ayMDSQF9Z2VV2a0XiB/preview";
        }));
        openPopupBtnPanel2.addEventListener("click", (() => {
            iframePanel2.src = "https://drive.google.com/file/d/1Hyau3qRstTL2QikjX5VKEpV9rkQHg4Il/preview";
        }));
        openPopupBtnPanel3.addEventListener("click", (() => {
            iframePanel3.src = "https://drive.google.com/file/d/195OlrATiMut4CDghpyQ_DNm6YygQWMZu/preview";
        }));
        openPopupBtnPanel4.addEventListener("click", (() => {
            iframePanel4.src = "https://drive.google.com/file/d/1APU2nmM0ZA90rKZH1VPO0E3ya2zkfWgn/preview";
        }));
        openPopupBtnPanel5.addEventListener("click", (() => {
            iframePanel5.src = "https://drive.google.com/file/d/1fnlUDDeao-HhgWVgRmQIGOxbr4OZhdxt/preview";
        }));
        openPopupBtnPanel6.addEventListener("click", (() => {
            iframePanel6.src = "https://drive.google.com/file/d/1fnlUDDeao-HhgWVgRmQIGOxbr4OZhdxt/preview";
        }));
        openPopupBtnPanelMobile1.addEventListener("click", (() => {
            iframePanel1.src = "https://drive.google.com/file/d/1lvuyKWoOtU-Jb5ayMDSQF9Z2VV2a0XiB/preview";
        }));
        openPopupBtnPanelMobile2.addEventListener("click", (() => {
            iframePanel2.src = "https://drive.google.com/file/d/1Hyau3qRstTL2QikjX5VKEpV9rkQHg4Il/preview";
        }));
        openPopupBtnPanelMobile3.addEventListener("click", (() => {
            iframePanel3.src = "https://drive.google.com/file/d/195OlrATiMut4CDghpyQ_DNm6YygQWMZu/preview";
        }));
        openPopupBtnPanelMobile4.addEventListener("click", (() => {
            iframePanel4.src = "https://drive.google.com/file/d/1APU2nmM0ZA90rKZH1VPO0E3ya2zkfWgn/preview";
        }));
        openPopupBtnPanelMobile5.addEventListener("click", (() => {
            iframePanel5.src = "https://drive.google.com/file/d/1fnlUDDeao-HhgWVgRmQIGOxbr4OZhdxt/preview";
        }));
        openPopupBtnPanelMobile6.addEventListener("click", (() => {
            iframePanel6.src = "https://drive.google.com/file/d/1fnlUDDeao-HhgWVgRmQIGOxbr4OZhdxt/preview";
        }));
        const openPopupBtnAio1 = document.querySelector("#aio-popup-button-1");
        const openPopupBtnAio2 = document.querySelector("#aio-popup-button-2");
        const iframeAio1 = document.querySelector("#iframe-aio-1");
        const iframeAio2 = document.querySelector("#iframe-aio-2");
        const openPopupBtnAioMobile1 = document.querySelector("#aio-popup-mobile-button-1");
        const openPopupBtnAioMobile2 = document.querySelector("#aio-popup-mobile-button-2");
        openPopupBtnAio1.addEventListener("click", (() => {
            iframeAio1.src = "https://drive.google.com/file/d/1vrNHd9-h43IJNZ_9_uGjPvAzePbK0l6A/preview";
        }));
        openPopupBtnAio2.addEventListener("click", (() => {
            iframeAio2.src = "https://drive.google.com/file/d/1b8wm9ZWmL-0-ueniNX42kfFVLabjNmsI/preview";
        }));
        openPopupBtnAioMobile1.addEventListener("click", (() => {
            iframeAio1.src = "https://drive.google.com/file/d/1vrNHd9-h43IJNZ_9_uGjPvAzePbK0l6A/preview";
        }));
        openPopupBtnAioMobile2.addEventListener("click", (() => {
            iframeAio2.src = "https://drive.google.com/file/d/1b8wm9ZWmL-0-ueniNX42kfFVLabjNmsI/preview";
        }));
        window["FLS"] = true;
        isWebp();
